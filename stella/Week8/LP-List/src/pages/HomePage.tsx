...
export const HomePage = () => {
  ...
  const {
    ...
    isFetchingNextPage,
    hasNextPage,
  } = useGetLpList({ search: debouncedSearch || undefined, order });
    ...
    return (
      <div className="p-6 w-full">
        <div className="mb-6 flex flex-col gap-4">
          <div className="w-full max-w-md h-10 bg-gray-200 animate-pulse rounded-md" />
  ...
  const hasResults = data && data.pages.length > 0;
    ...
    <div className="p-6 w-full self-start">
      <div className="mb-6 flex flex-col gap-4">
        <input
          ...
          className="w-full px-4 py-2 border border-[#444] rounded-md placeholder-gray-400 focus:outline-none focus:border-black transition-colors"
        />
        <div className="flex justify-end">
          <button
            onClick={toggleOrder}
