...
const validate = (values: PasswordFields): Partial<Record<keyof PasswordFields, string>> => {
...
function PasswordStep({ email, onNext }: Props) {
  ...
  const { values, errors, touched, handleChange, handleBlur, isValid } = useForm<PasswordFields>(
