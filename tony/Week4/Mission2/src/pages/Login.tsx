...
const validate = (values: LoginFields): Partial<Record<keyof LoginFields, string>> => {
...
function Login() {
  ...
  const { values, errors, touched, handleChange, handleBlur, isValid } = useForm<LoginFields>(
    { email: "", password: "" },
    validate
  );
