  ...
  return (
    <div className="flex flex-col items-center justify-center mt-20 px-4 text-white">
      <div className="w-full max-w-md flex flex-col gap-6">
            ...
            <>
              ...
              <button 
                ...
                className={`w-full py-4 mt-2 font-bold rounded-xl transition-all ${
                  canGoNext ? "bg-purple-600 text-white" : "bg-gray-800 text-gray-500"
                }`}
              >
                다음
              </button>
          ...
          {step === 2 && (
            <>
              ...
              <button 
                ...
                onClick={() => setStep(3)}
                className={`w-full py-4 mt-2 font-bold rounded-xl transition-all ${
                  canSubmit ? "bg-purple-600 text-white shadow-lg" : "bg-gray-800 text-gray-500"
                }`}
              >
                다음
              </button>
        ...
        <label htmlFor="nickname" className="text-sm ml-1 text-gray-400">닉네임</label>
        <input 
          type="text"
          id="nickname"
          name="nickname"
