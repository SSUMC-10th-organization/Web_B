...
import type { Credits, MovieDetail, CrewMember } from "../types/movieDetail";
      ...
      <div className="relative w-full h-[480px]">
        {movie.backdrop_path && (
          <img
            ...
            alt={movie.title}
            className="w-full h-full object-cover ovject-top"
          />
        )}
        <div className="absolute inset-0 bh-gradient-to-r from-black via-black/60 to-transparent" />
        <div className="absolute inset-0 bh-gradient-to-t from-black via-transparent to-transparent" />
